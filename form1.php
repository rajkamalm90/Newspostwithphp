...
<div class="col-75">
    ...
    <option value="harsh pant">Select Option</option>




<?php $qu="select * from writer"; $ru=mysqli_query($con,$qu); while($ro=mysqli_fetch_array($ru)){ $firstname=$ro['writer_name']; ?>		
...
<div class="col-75">
    ...
    <option value="bihar">Select Option</option>
...
<?php 
 if(isset($_POST['upload'])){
   ...
   move_uploaded_file($image_tmp,"image/$image_name");
    ...
    $query="insert into newsuplod(title,cate_name,writer_name,state_name,description,image,summary,status) values('$title','$cate_name','$writer_name','$state_name','$description','$image_name','$summary','1')"; 
